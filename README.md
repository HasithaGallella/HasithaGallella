<h3 align="left">Hi, I'm Hasitha Gallella</h3>
...
- Designing **Foundation AI Models** for 2D and 3D Vision tasks
- **Multimodal Large Language Models (MLLMs)** for domain-specific and cross-modal learning  
- **Efficient Training Strategies** for large-parameter Transformer models  
- **Image Processing** and **Computer Vision** applications for real-world use  
...
<details>
  ...
  **[Robot LUNA – Vision-based Restaurant Robot](https://github.com/LUNA-Vision-based-Restaurant-Robot)**  
  Dual-camera waiter robot for 3D navigation using ROS, TensorFlow, and Raspberry Pi.

  **[BioSense-AI – ECG-PPG Device & Mobile App](https://github.com/BioSense-AI)**  
  AI-driven health monitoring system integrating custom electronics, signal processing, and deep learning.

  **[HyperTalk – Sign Language Translator](https://github.com/HyperTalk-Computer-Vision)**  
  Real-time sign language translator using PyTorch, OpenCV, and ONNX with multilingual sign datasets.

  **[Smarty-Plug – IoT Smart Extension Cord](https://github.com/Smarty-Plug)**  
  ESP8266-based smart plug with voice control, scheduling, and adaptive USB charging.

  **[Cosmo Robot](https://github.com/Cosmo-Robot)**  
  Multi-sensor robotic platform for navigation, obstacle avoidance, and mechanical arm control.
...
<details>
  <summary><b>📚 Articles</b></summary><br/>
  
  - [Medium](https://medium.com/@hbgallella)  
  - [GitHub Articles](https://github.com/Articles-by-Hasitha-Gallella)
</details>
...
<p align="left">
  ...
  <a href="https://sites.google.com/view/hasitha-gallella/" target="_blank"><img src="https://raw.githubusercontent.com/HasithaGallella/HasithaGallella/545650cc5a7170efe70d683d58af3f858a967f59/Images/portfolio.svg" height="30" width="40" /></a>
